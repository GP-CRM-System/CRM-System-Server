...
const INDUSTRIES = [
    ...
    "Logistics", "Pharmaceuticals", "Chemical"
];

const JOB_TITLES = [
    // Executive
    "CEO", "CFO", "CTO", "COO", "CMO", "CIO", "VP of Sales", "VP of Engineering",
    "VP of Marketing", "VP of Operations", "President", "Managing Director",
    // Management
    ...
    "Senior Developer", "Senior Account Executive", "Senior Data Scientist",
    // Mid-level
    ...
    "Designer", "Developer", "Accountant", "Systems Administrator",
    // Entry-level
...
const COMPANY_TYPES = ["Public", "Private", "Non-Profit", "Government", "Partnership", "Sole Proprietorship"];
...
const ORDER_STAGES = ["Open", "Processing", "Shipped", "Delivered", "Cancelled", "Returned"];
...
const TICKET_STATUS_TYPES = ["Open", "In Progress", "Resolved", "Closed", "Pending", "Escalated"];
...
const TICKET_ISSUES = [
    ...
    "Third-party integration issue", "Database connection timeout"
];
...
const seedRoles = async () => {
    ...
    for (let i = 0; i < COUNTS.ROLES; i++) {
        ...
        rolesToCreate.push({
            name: roleName,
            description: ROLE_DESCRIPTIONS[roleName as keyof typeof ROLE_DESCRIPTIONS] || `Custom role with specific permissions`,
...
const runMassiveSeed = async () => {
    ...
    console.log("╔════════════════════════════════════════════════════════╗");
    console.log("║     NEXIFY CRM - MASSIVE DATABASE SEEDING             ║");
    console.log("╚════════════════════════════════════════════════════════╝\n");
